    ...
    <div class="header-content container d-flex align-items-center justify-content-between">
        ...
        <div class="header-left">
            <button type="button" class="btn btn-link p-0 d-flex align-items-center" onclick="history.back()">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#300708"
        ...
        <div class="header-center text-center ">
            <a href="/" class="d-inline-block mx-auto"><img src="{{ asset('image/logo.png') }}"
                    alt="Tanishq Rivaah Wedding Jewellery" class="tanishq-logo"></a>
        </div>
        ...
        <div class="d-flex justify-content-end wishlist-btn">
            ...
            <div class="header-right">
                <a href="{{route('wishlist.page')}}" class="d-inline-block mx-auto text-decoration-none">
                    <button type="button" class="btn btn-link p-0 d-flex align-items-center" aria-label="Wishlist" onclick="posthog.capture('wishlist-screen-btn-clicked')">
