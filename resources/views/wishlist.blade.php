                        ...
                        <div class="product-item-card">
                            ...
                            <div class="product-item-body">
                                ...
                                <div class="product-item-buttons">
                                    <button class="btn " style="border:2px solid #8a2323;color:#8a2323;font-weight:500;" onclick="posthog.capture('View-Details-clicked', {sku: '{{ $product['sku'] }}', category: '{{ $product['categoryKey'] ?? '' }}'});">
                                        <a class="base-color text-decoration-none" href="/product/{{ $product['sku'] }}?category={{ $product['categoryKey'] ?? '' }}">View Details</a>
                                    </button>

                                     <button id="tryOnButton"  class="btn btn-outline-secondary try-on-btn" data-sku="{{ $product['sku'] }}" style="border:2px solid #8a2323;background:#8a2323;color:#fff;font-weight:500;" onclick="posthog.capture('Try-On-clicked', {sku: '{{ $product['sku'] }}', category: '{{ $product['categoryKey'] ?? '' }}'});">Try On</button>
