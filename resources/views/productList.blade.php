                                ...
                                <div class="product-item-card">
                                    ...
                                    <div class="product-item-body">
                                        ...
                                        <div class="product-item-buttons">
                                            <button class="btn" style="border:2px solid #8a2323;color:#8a2323;font-weight:500;" onclick="posthog.capture('View-Details-clicked', {variantSku: '${product.variants?.[0]?.variantSku || ''}', categoryKey: '${categoryKey}'})">
                                                <a class="base-color text-decoration-none" href="/product/${product.variants?.[0]?.variantSku }?category=${categoryKey}"> View Details </a>
                                            </button>
                                            <button class="btn btn-outline-secondary try-on-btn" data-sku="${product.variants?.[0]?.variantSku || ''}" style="background:#8a2323;color:#fff;font-weight:500;" onclick="posthog.capture('Try-On-clicked', {variantSku: '${product.variants?.[0]?.variantSku || ''}', category: '${categoryKey}'})">Try On</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="product-item-card">
                            ...
                            <div class="product-item-body">
                                ...
                                <div class="product-item-buttons">
                                    ...
                                    <button class="btn btn-outline-secondary try-on-btn" data-sku="${product.variants?.[0]?.variantSku || ''}" style="background:#8a2323;color:#fff;font-weight:500;" onclick="posthog.capture('Try-On-clicked', {variantSku: '${product.variants?.[0]?.variantSku || ''}', categoryKey: '${categoryKey}'})">Try On</button>
                                </div>
                            </div>
                        </div>
                    </div>
