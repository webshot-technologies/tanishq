                                    ...
                                    <div class="product-item-body">
                                        ...
                                        <div class="product-item-buttons">
                                            ...
                                            <button id="tryOnButton" class="btn btn-outline-secondary try-on-btn"
                                                ...
                                                style="border:2px solid #8a2323;background:#8a2323;color:#fff;font-weight:500;" onclick="posthog.capture('Try-On-clicked', {sku: '{{ $product['sku'] }}', category: '{{ $product['categoryKey'] ?? '' }}')">Try
                                                On</button>
