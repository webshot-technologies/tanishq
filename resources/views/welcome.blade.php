...
<body>
    ...
    <div class="container px-0">
        ...
        <div class="step-container  active mx-auto " id="step1" style="height: 100vh;">
            <div class="row align-items-center my-4 mx-auto ">
                <div class="col-12 col-xl-10 card px-0 shadow-lg mx-auto rounded-4 overflow-hidden h-100 ">
                    <div class="row g-0 h-100">
                        ...
                        <div id="step-section-container" class="col-lg-6 p-0 banner-height">
                            <!-- Step 1 Content -->
                            <div class="d-flex flex-column justify-content-between bg-custom-light p-4 p-md-5 banner-height">
                                <div class=" text-custom-dark">
                                    <!-- Logo and Headline -->
                                    <div class="mb-5 ">
                                        <div class="d-flex flex-column align-items-start">
                                            <img src="{{ asset('image/logo.png') }}" style="width: 150px; height: auto;"
                                                class="mb-2" alt="Tanishq Logo">
                    ...
                    &copy; Powered by <a href="https://www.mirrar.com/" class="base-color"> MIRRAR </a>
                        ...
                        <div class="col-lg-6 col-12  p-0 banner-height">
                            <img src="{{ asset('image/input-form.webp') }}" alt="Wedding jewelry on hands"
        ...
        <!-- STEP 2 -->
        <div id="step2" class="step-container " style="min-height: 100vh">
            <div class="row align-items-center my-4">
                <div
                    ...
                    <div class="text-center mb-4 d-flex align-items-center justify-content-center" style="gap: 1rem;">
                        ...
                        <img src="{{ asset('image/logo.png') }}" style="width: 150px; height: auto;" class="mb-3"
                            alt="Tanishq Rivaah Logo">
                    ...
                    <div class="row text-center outfit-selection-row mt-4">
                        ...
                        <div class="d-flex flex-nowrap overflow-auto px-3 w-100 ">
                            ...
                            <!-- Card 1 -->
                            <div class="outfit-card-wrapper px-2">
                                <div class="card outfit-card bg-transparent" data-outfit="gown">
                            ...
                            <!-- Card 2 -->
                            <div class="outfit-card-wrapper px-2">
                                <div class="card outfit-card bg-transparent active" data-outfit="lehanga">
    ...
    <div class="step-container container  " id="step3">
        <div class="row align-items-center  ">
            ...
            <div
                ...
                <div class=" text-center text-muted small mt-4 px-md-5">
                    <p class="fw-bold text-dark mb-2 text-start">Note</p>
                    <p class="text-start">Please be advised that this checklist does not obligate you to make purchases from Tanishq.
